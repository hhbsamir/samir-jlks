  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-8 bg-background">
      <div className="text-center mb-12">
        <h1 className="font-headline text-6xl md:text-8xl font-bold text-primary animate-fade-in-down">
          Adjudicator's Arena
        </h1>
        <p className="font-body text-xl md:text-2xl mt-4 text-foreground/80 max-w-3xl mx-auto animate-fade-in-up">
...
function PortalCard({ href, icon, title, description }: { href: string; icon: React.ReactNode; title: string; description: string; }) {
  return (
    <Card className="group transform transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-primary/20 border-2 border-transparent hover:border-primary/50 overflow-hidden">
      ...
      <CardContent className="text-center flex flex-col items-center gap-6 p-8 pt-0">

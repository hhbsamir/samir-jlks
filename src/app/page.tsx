...
function PortalCard({ href, icon, title }: { href: string; icon: React.ReactNode; title: string; }) {
  return (
    <Card className="group transform transition-all duration-300 hover:scale-105 hover:shadow-2xl hover:shadow-primary/20 border-2 border-transparent hover:border-primary/50 overflow-hidden bg-card/80 backdrop-blur-sm">
